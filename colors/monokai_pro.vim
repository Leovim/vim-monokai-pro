...
hi Visual ctermfg=NONE ctermbg=236 cterm=NONE guifg=NONE guibg=#403e41 gui=NONE
...
hi LineNr ctermfg=246 ctermbg=236 cterm=NONE guifg=#959394 guibg=#303030 gui=NONE
hi VertSplit ctermfg=59 ctermbg=236 cterm=NONE guifg=#696769 guibg=#696769 gui=NONE
hi MatchParen ctermfg=204 ctermbg=NONE cterm=underline guifg=#ff6188 guibg=NONE gui=underline
hi StatusLine ctermfg=231 ctermbg=236 cterm=bold guifg=#fcfcfa guibg=#696769 gui=bold
hi StatusLineNC ctermfg=231 ctermbg=236 cterm=NONE guifg=#fcfcfa guibg=#696769 gui=NONE
hi Pmenu ctermfg=150 ctermbg=NONE cterm=NONE guifg=#a9dc76 guibg=NONE gui=NONE
hi PmenuSel ctermfg=NONE ctermbg=236 cterm=NONE guifg=NONE guibg=#403e41 gui=NONE
...
hi SpecialKey ctermfg=240 ctermbg=236 cterm=NONE guifg=#5b595c guibg=#303030 gui=NONE
